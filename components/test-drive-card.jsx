    ...
    <>
      ...
      >
        <div className="flex flex-col sm:flex-row">
          <div className="sm:w-1/4 relative aspect-[4/3] sm:aspect-auto">
          ...
          <div className="p-4 sm:w-3/4 sm:flex-1 flex flex-col sm:flex-row">
            ...
            {showActions && (
              <div className="p-4 border-t sm:border-t-0 sm:border-l sm:w-1/4 sm:flex sm:flex-col sm:justify-center sm:items-center sm:space-y-2">
                ...
                >
                  ...
                  >
                    <span className="truncate">View Car</span>
