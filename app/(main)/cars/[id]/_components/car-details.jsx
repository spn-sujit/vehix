...
const CarDetails = ({ car, testDriveInfo }) => {
  ...
  const handleSaveCar = async (e) => {
    e.preventDefault();
    if (!isSignedIn) {
      toast.warning("Please sign in to save cars");
      router.push("/sign-in");
      return;
    }
    if (savingCar) return;
    ...
    if (navigator.share) {
      navigator
        .share({
          ...
          text: `Check out this ${car.year} ${car.make} ${car.model} on Vehix`,
  ...
  const handleBookTestDrive = () => {
    if (!SignIn) {
      toast.warning("Please sign in to book a test drive");
      router.push("/sign-in");
      return;
    }
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div>
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle> Vehix Car Loan Calculator</DialogTitle>
          ...
          {car.status !== "SOLD" && car.status !== "UNAVAILABLE" && (
            <Button
              ...
              disabled={!isSignedIn ||testDriveInfo.userTestDrive}
              onClick={handleBookTestDrive}
            >
              {!isSignedIn ? ('Login in book Test Drive'):(
                <>
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          <div className="flex flex-col md:flex-row gap-6 justify-between">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="text-gray-600 mt-1">Vehix Motors</h4>
                ...
                {testDriveInfo.dealership?.workingHours
                  ? testDriveInfo.dealership.workingHours
                      ...
                      .map((day) => (
                        <div
                          key={day.dayOfWeek}
                          className="flex justify-between items-center py-1 text-sm border-b border-gray-200"
                        >
